...
- **Release:** [1.5.3](https://github.com/zfoxer/foo_scrobbler_mac/releases/tag/v1.5.3)  
- **OS support:** macOS **11.5+** (Intel, ARM)

### Windows
- **Repo:** [foo_scrobbler_win](https://github.com/zfoxer/foo_scrobbler_win)  
- **Release:** [1.5.2](https://github.com/zfoxer/foo_scrobbler_win/releases/tag/v1.5.2)  
